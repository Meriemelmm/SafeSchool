...
export const metadata = {
  title: 'Gestion des Signalements | SafeSchool Admin',
  description: 'Gérez tous les signalements de la plateforme SafeSchool depuis votre tableau de bord administrateur.',
};
